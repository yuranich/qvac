...
## Step 2: Generate the PR description (message only)

Use `@PULL_REQUEST_TEMPLATE.md` as the template. Fill it in based on the combined change set and return the completed PR description to the user as a message. If there are additional instructions in the template file, follow them too.
