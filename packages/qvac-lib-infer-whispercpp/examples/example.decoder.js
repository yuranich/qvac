...
async function main () {
  ...
  try {
    ...
    const audioFilePath = path.join(__dirname, 'samples/LastQuestion_long_EN.mp3')
    const outputFilePath = path.join(__dirname, 'samples/LastQuestion_long_EN.out.s16le')
