...
| handlers | `Record<string,` [`PluginHandlerDefinition`](/sdk/api/defineHandler#pluginhandlerdefinition)`>` | ✓ | Map of handler names to handler definitions |
...
See the [Write a custom plugin](/sdk/utilities/write-custom-plugin) guide for a full walkthrough.
