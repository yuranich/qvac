...
| onProgress | `(progress:` [`ModelProgressUpdate`](/sdk/api/loadModel#modelprogressupdate)`) => void` | ✗ | Callback for real-time download progress updates. When provided, streaming is used. |
