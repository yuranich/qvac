...
| --- | --- | --- |
| LLM | `@qvac/sdk/llamacpp-completion/plugin` | [Completion](/sdk/ai-tasks/completion); [multimodal](/sdk/ai-tasks/multimodal); [RAG](/sdk/ai-tasks/rag) |
| Embeddings | `@qvac/sdk/llamacpp-embedding/plugin` | [Text embeddings](/sdk/ai-tasks/text-embeddings); [RAG](/sdk/ai-tasks/rag) |
| ASR with `whisper.cpp` | `@qvac/sdk/whispercpp-transcription/plugin` | [Transcription](/sdk/ai-tasks/transcription) |
| ASR with Parakeet | `@qvac/sdk/parakeet-transcription/plugin` | [Transcription](/sdk/ai-tasks/transcription) |
| NMT | `@qvac/sdk/nmtcpp-translation/plugin` | [Translation](/sdk/ai-tasks/translation) |
| TTS | `@qvac/sdk/onnx-tts/plugin` | [Text-to-Speech](/sdk/ai-tasks/text-to-speech) |
| OCR | `@qvac/sdk/onnx-ocr/plugin` | [OCR](/sdk/ai-tasks/ocr) |
...
* [Write a custom plugin](/sdk/utilities/write-custom-plugin).