...
- If the model is sharded across multiple files (a multi-file bundle), see [Sharded models](/v0.6.1/sdk/utilities/sharded-models).
- For multimodal prompts (images + text), see [Multimodal](/v0.6.1/sdk/ai-tasks/multimodal).
