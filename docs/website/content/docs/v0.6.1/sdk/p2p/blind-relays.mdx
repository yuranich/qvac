...
Blind relays help establish peer connections through NAT/firewalls by routing traffic through relay nodes. Use it for model downloads from [our model registry](/v0.6.1/sdk#models) and for delegated inference scenarios where peers may be behind restrictive network configurations.
