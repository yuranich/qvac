...
1. [`getLogger()`](/v0.6.1/sdk/api/getLogger) — create a logger
2. [`loadModel()`](/v0.6.1/sdk/api/loadModel) — pass logger via `logger` option
3. [`loggingStream()`](/v0.6.1/sdk/api/loggingStream) — stream real-time logs from models or SDK server
