...
| onProgress | `(progress:` [`ModelProgressUpdate`](/v0.6.1/sdk/api/loadModel#modelprogressupdate)`) => void` | ✗ | Callback for real-time download progress updates. When provided, streaming is used. |
