...
`Promise<`[`ModelRegistryEntry[]`](/v0.6.1/sdk/api/modelRegistryGetModel#modelregistryentry)`>` — Matching model entries. See [`modelRegistryGetModel()`](/v0.6.1/sdk/api/modelRegistryGetModel#modelregistryentry) for the `ModelRegistryEntry` shape.
