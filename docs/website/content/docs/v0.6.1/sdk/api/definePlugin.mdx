...
| handlers | `Record<string,` [`PluginHandlerDefinition`](/v0.6.1/sdk/api/defineHandler#pluginhandlerdefinition)`>` | ✓ | Map of handler names to handler definitions |
...
See the [Write a custom plugin](/v0.6.1/sdk/utilities/write-custom-plugin) guide for a full walkthrough.
