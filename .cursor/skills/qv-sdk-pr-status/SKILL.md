...
description: Team-wide PR dashboard for the SDK pod. Shows open PRs touching SDK pod paths, sorted oldest-first, grouped into needs-your-re-review / stale / needs-review, with merge-conflict warnings. Use when checking team SDK pod PR status or invoking /qv-sdk-pr-status.
