...
- Project-specific gotchas belong in a project-scoped skill (e.g. `.cursor/skills/qv-registry-autobase-patterns/`) or `.cursor/rules/<project>/`, not in this skill.
